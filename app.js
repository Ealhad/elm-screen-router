...
var _user$project$First_Model$init = {counter: 0};
var _user$project$First_Model$Model = function (a) {
	return {counter: a};
};

var _user$project$Router$Route = F3(
	function (a, b, c) {
		return {screen: a, url: b, header: c};
	});
var _user$project$Router$Second = {ctor: 'Second'};
var _user$project$Router$Third = {ctor: 'Third'};
var _user$project$Router$First = {ctor: 'First'};
var _user$project$Router$Main = {ctor: 'Main'};
var _user$project$Router$screens = {
	ctor: '::',
	_0: A3(_user$project$Router$Route, _user$project$Router$Main, '', ''),
	_1: {
		ctor: '::',
		_0: A3(_user$project$Router$Route, _user$project$Router$First, 'first', 'First Screen'),
		_1: {
			ctor: '::',
			_0: A3(_user$project$Router$Route, _user$project$Router$Second, 'second', 'Second Screen'),
			_1: {
				ctor: '::',
				_0: A3(_user$project$Router$Route, _user$project$Router$Third, 'third', 'Third Screen'),
				_1: {ctor: '[]'}
			}
		}
	}
};
var _user$project$Router$route = function (screen) {
	var isCurrent = function (route) {
		return _elm_lang$core$Native_Utils.eq(route.screen, screen);
	};
	var routes = A2(_elm_lang$core$List$filter, isCurrent, _user$project$Router$screens);
	var _p0 = routes;
	if (_p0.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
...
var _user$project$Router$header = function (screen) {
	var _p1 = _user$project$Router$route(screen);
	if (_p1.ctor === 'Just') {
		return _p1._0.header;
	} else {
		return '';
	}
};
var _user$project$Router$url = function (screen) {
	var _p2 = _user$project$Router$route(screen);
	if (_p2.ctor === 'Just') {
		return A2(_elm_lang$core$Basics_ops['++'], '#', _p2._0.url);
	} else {
		return '';
	}
};
var _user$project$Router$screenFromLocation = function (location) {
	var isCurrent = function (_p3) {
		var _p4 = _p3;
		return _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Basics_ops['++'], '#', _p4.url),
			A2(_elm_lang$core$Debug$log, 'location', location.hash));
	};
	var screenList = A2(_elm_lang$core$List$filter, isCurrent, _user$project$Router$screens);
	var _p5 = screenList;
	if ((_p5.ctor === '::') && (_p5._1.ctor === '[]')) {
		return _p5._0.screen;
	} else {
		return _user$project$Router$Main;
	}
};

var _user$project$Second_Model$init = {counter: 0};
var _user$project$Second_Model$Model = function (a) {
	return {counter: a};
};

var _user$project$Third_Model$init = {counter: 0};
var _user$project$Third_Model$Model = function (a) {
	return {counter: a};
};
...
var _user$project$Model$init = function (location) {
	return {
		...
		first: _user$project$First_Model$init,
		second: _user$project$Second_Model$init,
		third: _user$project$Third_Model$init
	};
};
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {globalCounter: a, mdl: b, screen: c, first: d, second: e, third: f};
	});

var _user$project$First_Update$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$First_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$First_Update$Mdl, _p0._0, model);
			case 'IncrementCounter':
				var first = model.first;
				var counter = model.first.counter;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							first: _elm_lang$core$Native_Utils.update(
								first,
								{counter: counter + 1})
						}),
					{ctor: '[]'});
...
var _user$project$First_Update$IncrementCounter = {ctor: 'IncrementCounter'};
var _user$project$First_Update$Reset = {ctor: 'Reset'};

var _user$project$First_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Button pushed in this screen: '),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(model.first.counter)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Button pushed in all screens: '),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(model.globalCounter)),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A5(
								...
								_user$project$First_Update$Mdl,
								{
									ctor: '::',
									_0: 0,
									_1: {ctor: '[]'}
								...
								model.mdl,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$onClick(_user$project$First_Update$IncrementCounter),
											_1: {ctor: '[]'}
										}
									}
								},
...
var _user$project$Second_Update$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Second_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Second_Update$Mdl, _p0._0, model);
			case 'IncrementCounter':
				var second = model.second;
				var counter = model.second.counter;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							globalCounter: model.globalCounter + 1,
							second: _elm_lang$core$Native_Utils.update(
								second,
								{counter: counter + 1})
						}),
					{ctor: '[]'});
...
var _user$project$Second_Update$IncrementCounter = {ctor: 'IncrementCounter'};
var _user$project$Second_Update$Reset = {ctor: 'Reset'};

var _user$project$Third_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'IncrementCounter') {
			var third = model.third;
			var counter = model.third.counter;
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_elm_lang$core$Native_Utils.update(
					model,
					{
						globalCounter: model.globalCounter + 1,
						third: _elm_lang$core$Native_Utils.update(
							third,
							{counter: counter + 1})
					}),
				{ctor: '[]'});
...
var _user$project$Third_Update$IncrementCounter = {ctor: 'IncrementCounter'};
var _user$project$Third_Update$Reset = {ctor: 'Reset'};
...
var _user$project$Update$wrapScreen = F2(
	function (toMsg, _p0) {
		...
		return {
			ctor: '_Tuple2',
			_0: _p1._0,
			_1: A2(_elm_lang$core$Platform_Cmd$map, toMsg, _p1._1)
		};
	});
var _user$project$Update$ThirdEvent = function (a) {
	return {ctor: 'ThirdEvent', _0: a};
};
var _user$project$Update$SecondEvent = function (a) {
	return {ctor: 'SecondEvent', _0: a};
};
var _user$project$Update$FirstEvent = function (a) {
	return {ctor: 'FirstEvent', _0: a};
};
var _user$project$Update$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
		...
		switch (_p2.ctor) {
			case 'ChangeLocation':
				return A2(
					...
					{ctor: '[]'});
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Update$Mdl, _p2._0, model);
			case 'FirstEvent':
				return A2(
					_user$project$Update$wrapScreen,
					_user$project$Update$FirstEvent,
					A2(_user$project$First_Update$update, _p2._0, model));
			case 'SecondEvent':
				return A2(
					_user$project$Update$wrapScreen,
					_user$project$Update$SecondEvent,
					A2(_user$project$Second_Update$update, _p2._0, model));
			case 'ThirdEvent':
				return A2(
					_user$project$Update$wrapScreen,
					_user$project$Update$ThirdEvent,
					A2(_user$project$Third_Update$update, _p2._0, model));
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
...
var _user$project$Update$ChangeLocation = function (a) {
	return {ctor: 'ChangeLocation', _0: a};
};
var _user$project$Update$Reset = {ctor: 'Reset'};

var _user$project$Screen$empty = function (_p0) {
	return {ctor: '[]'};
};
var _user$project$Screen$drawerElements = function (model) {
	var screenLink = function (_p1) {
		var _p2 = _p1;
		var _p3 = _p2.screen;
		return A2(
			...
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Layout$href(
					_user$project$Router$url(_p3)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					_user$project$Router$header(_p3)),
				_1: {ctor: '[]'}
			});
	};
	return A2(_elm_lang$core$List$map, screenLink, _user$project$Router$screens);
};
var _user$project$Screen$viewDrawer = function (elements) {
	return A2(
		_debois$elm_mdl$Material_Layout$navigation,
		{ctor: '[]'},
		elements);
};
var _user$project$Screen$viewTabs = function (model) {
	return {ctor: '[]'};
};
var _user$project$Screen$viewHeader = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_user$project$Router$header(model.screen)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Screen$defaultLayout = F2(
	function (model, viewBody) {
		return A4(
			_debois$elm_mdl$Material_Layout$render,
			_user$project$Update$Mdl,
			model.mdl,
			{
				ctor: '::',
			...
			},
			{
				header: {
					ctor: '::',
					_0: _user$project$Screen$viewHeader(model),
					_1: {ctor: '[]'}
				},
				drawer: {
					ctor: '::',
					_0: _user$project$Screen$viewDrawer(
						_user$project$Screen$drawerElements(model)),
					_1: {ctor: '[]'}
				},
				tabs: {
					ctor: '_Tuple2',
					_0: _user$project$Screen$viewTabs(model),
					_1: {
						ctor: '::',
...
var _user$project$Second_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(model.second.counter)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A5(
								_debois$elm_mdl$Material_Button$render,
								_user$project$Second_Update$Mdl,
								{
									ctor: '::',
									_0: 0,
									_1: {ctor: '[]'}
								...
								model.mdl,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Second_Update$IncrementCounter),
											_1: {ctor: '[]'}
										}
									}
								},
...
var _user$project$Third_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$a,
				{
					...
					_0: _elm_lang$html$Html_Attributes$href(
						_user$project$Router$url(_user$project$Router$Main)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Third Screen'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(model.third.counter)),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Third_Update$IncrementCounter),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
...
var _user$project$View$block = F2(
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'margin', _1: '10%'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'text-align', _1: textAlign},
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _user$project$View$Center = {ctor: 'Center'};
var _user$project$View$logo = A2(
	_user$project$View$block,
	_user$project$View$Center,
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$img,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$src('/static/img/logo_full.png'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
						{
...
var _user$project$View$firstLink = A2(
	_user$project$View$block,
	_user$project$View$Center,
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$a,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href(
					_user$project$Router$url(_user$project$Router$First)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$View$thirdLink = A2(
	_user$project$View$block,
	_user$project$View$Center,
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$a,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href(
					_user$project$Router$url(_user$project$Router$Third)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Third'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _user$project$View$secondLink = A2(
	_user$project$View$block,
	_user$project$View$Center,
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$a,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href(
					_user$project$Router$url(_user$project$Router$Second)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$View$Right = {ctor: 'Right'};
var _user$project$View$copyright = A2(
	_user$project$View$block,
	_user$project$View$Right,
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('© 2018 Anton Shvein aka war1and'),
		_1: {ctor: '[]'}
	});
	...
	switch (_p1.ctor) {
			...
			return A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'border', _1: '#000 1px solid'},
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$View$firstLink,
					_1: {
						ctor: '::',
						_0: _user$project$View$secondLink,
						_1: {
							ctor: '::',
							_0: _user$project$View$thirdLink,
							_1: {
								ctor: '::',
								_0: _user$project$View$copyright,
								_1: {ctor: '[]'}
							}
						}
					}
			...
			var view = function (m) {
				return {
					...
					_0: A2(
						...
						_user$project$Update$FirstEvent,
						_user$project$First_View$view(m)),
					_1: {ctor: '[]'}
				};
			};
			return A2(_user$project$Screen$defaultLayout, model, view);
		case 'Second':
			var view = function (m) {
				return {
					ctor: '::',
					_0: A2(
						_user$project$View$wrapScreen,
						_user$project$Update$SecondEvent,
						_user$project$Second_View$view(m)),
					_1: {ctor: '[]'}
				};
			};
			return A2(_user$project$Screen$defaultLayout, model, view);
		default:
			return A2(
				_user$project$View$wrapScreen,
				_user$project$Update$ThirdEvent,
				_user$project$Third_View$view(model));
	}
};
var _user$project$View$Left = {ctor: 'Left'};
var _user$project$View$backLink = A2(
	_user$project$View$block,
	_user$project$View$Left,
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$a,
...
var _user$project$Subscription$subscriptions = function (model) {
	return A2(_debois$elm_mdl$Material$subscriptions, _user$project$Update$Mdl, model);
};
...
var _user$project$Main$init = function (location) {
	return A2(
		...
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material$init(_user$project$Update$Mdl),
			_1: {ctor: '[]'}
		});
};
